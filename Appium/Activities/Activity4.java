...
public class Activity4 {
	...
	public void createContact() {
		...
		driver.findElementByXPath("//android.widget.EditText[@text='First name']").sendKeys("Vidhya");
		driver.findElementByXPath("//android.widget.EditText[@text='Last name']").sendKeys("Keerthi");
		driver.findElementByXPath("//android.widget.EditText[@text='Phone']").sendKeys("980025243");
        ...
        Assert.assertEquals(contactName, "Vidhya Keerthi");
	}
